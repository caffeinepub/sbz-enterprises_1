...
const productName = "Double Filtered Neem Oil";
const productDetails = `Product: ${productName}\nPrice Range: $1.50–2.20/kg (FOB India)\nProcess: Double mechanical filtration\nGrade: Premium / Cosmetic Grade\nKey use: Cosmetic manufacturing, herbal soap, pharmaceutical topical preparations`;
...
export default function DoubleFilteredNeemOil() {
  return (
    <div>
      <section
      ...
      >
        <div className="max-w-5xl mx-auto">
          <h1 className="text-4xl font-bold mb-3">Double Filtered Neem Oil</h1>
          <p className="text-green-200 text-lg">
            Superior clarity for cosmetic and pharmaceutical applications
          </p>
        </div>
      </section>
        ...
        <div className="grid md:grid-cols-2 gap-10">
          <div>
            ...
            <p className="text-gray-600 mb-6">
              Double filtered neem oil is further processed through a secondary
              filtration stage to achieve superior clarity and purity. This
              premium grade is preferred by cosmetic manufacturers and herbal
              product formulators who require a clean, consistent oil.
            </p>
            <h3
            ...
            <table className="w-full text-sm border-collapse">
              <tbody>
                {[
                  ["Appearance", "Light brown, clear oil"],
                  ["Odor", "Mild neem aroma"],
                  ["Process", "Double mechanical filtration"],
                  ["Grade", "Premium / Cosmetic Grade"],
                ].map(([k, v]) => (
          ...
          <div className="space-y-4">
            <div className="bg-green-50 rounded-xl border border-green-100 p-5">
              ...
              <ul className="text-sm text-gray-600 space-y-1">
                {[
                  "Cosmetic manufacturing (face oils, serums)",
                  "Herbal soap production",
                  "Skin care and hair care formulations",
                  "Pharmaceutical topical preparations",
                ].map((a) => (
                  <li key={a}>• {a}</li>
                ))}
              </ul>
